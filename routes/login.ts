...
models.sequelize.query('SELECT * FROM Users WHERE email = :email AND deletedAt IS NULL', { replacements: { email: req.body.email || '' }, model: UserModel, plain: true, type: models.sequelize.QueryTypes.SELECT })
